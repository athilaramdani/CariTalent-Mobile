...
class TalentChangePasswordPage extends ConsumerStatefulWidget {
  const TalentChangePasswordPage({super.key});

  static const routePath = '/talent/change-password';

  @override
  ConsumerState<TalentChangePasswordPage> createState() =>
      _TalentChangePasswordPageState();
}

class _TalentChangePasswordPageState
    extends ConsumerState<TalentChangePasswordPage> {
